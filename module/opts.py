...
def get_args():
    ...
    parser.add_argument('--candidate_type', type=str, default='0shot',help='candidate type')
    parser.add_argument("--loss_bow", default=0.01, type=float)
    parser.add_argument("--loss_kl", default=0.001, type=float)
    parser.add_argument("--cand_num", default=3, type=int)
    parser.add_argument('--predrank_path', type=str, default='/data/home/scv0028/run/wpc/huggingface/roberta-base',help='predrank_path')
    parser.add_argument('--rank_type', type=str, default='RougeL',help='rank index type')
    parser.add_argument("--use_z2", type=str2bool, nargs='?',const=True,default=True)
