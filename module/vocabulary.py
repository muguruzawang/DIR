...
class WordVocab(object):
    ...
    def __init__(self, vocab_file, max_size):
        ...
        for w in [UNKNOWN_TOKEN, PAD_TOKEN, START_DECODING, STOP_DECODING, START_DOCUMENT, STOP_DOCUMENT]:
        ...
        with open(vocab_file, 'r', encoding='utf8') as vocab_f: #New : add the utf8 encoding to prevent error
            ...
            for line in vocab_f:
                ...
                w = pieces[0]
                # print(w)
                if w in [UNKNOWN_TOKEN, PAD_TOKEN, START_DECODING, STOP_DECODING, START_DOCUMENT, STOP_DOCUMENT]:
