...
if __name__ == '__main__':
    ...
    train_text_file = os.path.join(args.data_dir, "train_gptctr_all.json")
    
    val_text_file = os.path.join(args.data_dir, "val.json")
    
    test_text_file = os.path.join(args.data_dir, "test_gptctr_all.json")

    predrank_path = args.predrank_path
    ...
    if (args.mode == 'train'):
        train_dataset = ExampleSet(train_text_file, predrank_path,rank_type, wordvocab, args.sent_max_len, args.doc_max_timesteps, args.docset_max_len, args.cand_num, True, args.device)
        #train_sampler = torch.utils.data.distributed.DistributedSampler(train_dataset)
        ...
        valid_dataset = ExampleSet(val_text_file, predrank_path, rank_type, wordvocab, args.sent_max_len, args.doc_max_timesteps, args.docset_max_len, args.cand_num, False, args.device)
        ...
        test_dataset = ExampleSet(test_text_file,predrank_path, rank_type, wordvocab, args.sent_max_len, args.doc_max_timesteps, args.docset_max_len, args.cand_num,  False, args.device)
